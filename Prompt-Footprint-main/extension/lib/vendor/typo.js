/*
 * Vendored: Typo.js v1.3.2 — https://github.com/cfinke/Typo.js
 * License: BSD-3-Clause (c) Christopher Finke.
 * Unmodified. Bundled (rather than via npm) so the content script can load it
 * offline with no build step. Dictionaries live in ../dict/ (see dict/README.md).
 * Usable as a browser global (top-level `var Typo`) and as a Node module
